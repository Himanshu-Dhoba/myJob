...
import { deleteJob, checkJob, applyJob, jobApplication } from "../../store/actions/jobActions";
    ...
    <>
      <div>
        <div>
          ...
          <br></br>
          <Typography variant="body2" className={classes.moreStyle}>
            <LocationOnOutlined className="icon" /> {job.location}
            {userRole === 0 ? <Button size="small" onClick={handleClickOpen('paper')} className="application-btn">View Applications</Button> : <Button size="small" onClick={handleView} className="application-btn">Apply</Button>}
          </Typography>
        </div>
        <div>
        </div>
